...
from basedataset_transformer import BaseDataset_Transformer as BaseDataset


class CAMELS_CH_Transformer(BaseDataset):
    ...
    def __init__(self, 
        ...
        super(CAMELS_CH_Transformer, self).__init__(dynamic_input = dynamic_input,
                                        target = target, 
